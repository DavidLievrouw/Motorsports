  ...
  public partial class ListDetails : Page {
    ...
    protected void Page_Load(object sender, EventArgs e) {
      ...
      if (!Page.IsPostBack && table.HasPrimaryKey) {
        ...
        if (GridView1.SelectedPersistedDataKey == null) GridView1.SelectedIndex = 0;
      }
    ...
    protected void GridView1_DataBound(object sender, EventArgs e) {
      if (GridView1.Rows.Count == 0) FormView1.ChangeMode(FormViewMode.Insert);
    }
    ...
    protected void FormView1_ModeChanging(object sender, FormViewModeEventArgs e) {
      if (e.NewMode != FormViewMode.ReadOnly) GridView1.EditIndex = -1;
    }

    protected void FormView1_PreRender(object sender, EventArgs e) {
      if (FormView1.Row != null) SetDeleteConfirmation(FormView1.Row);
    }

    void SetDeleteConfirmation(TableRow row) {
      foreach (Control c in row.Cells[0].Controls) {
        var button = c as LinkButton;
        if (button != null && button.CommandName == DataControlCommands.DeleteCommandName) button.OnClientClick = "return confirm('Are you sure you want to delete this item?');";
      }
    }
  }
}