/****** Object:  Database [Motorsports]    Script Date: 08/02/2020 16:17:06 ******/
CREATE DATABASE [Motorsports]  (EDITION = 'Basic', SERVICE_OBJECTIVE = 'Basic', MAXSIZE = 1 GB) WITH CATALOG_COLLATION = SQL_Latin1_General_CP1_CI_AS;
GO
...
GO
/****** Object:  User [MotorsportsApp]    Script Date: 08/02/2020 16:17:07 ******/
...
GO
/****** Object:  Table [dbo].[Country]    Script Date: 08/02/2020 16:17:08 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Participant]    Script Date: 08/02/2020 16:17:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Round]    Script Date: 08/02/2020 16:17:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RoundWinner]    Script Date: 08/02/2020 16:17:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Season]    Script Date: 08/02/2020 16:17:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SeasonEntry]    Script Date: 08/02/2020 16:17:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SeasonWinner]    Script Date: 08/02/2020 16:17:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Sport]    Script Date: 08/02/2020 16:17:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Status]    Script Date: 08/02/2020 16:17:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Team]    Script Date: 08/02/2020 16:17:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[User]    Script Date: 08/02/2020 16:17:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Venue]    Script Date: 08/02/2020 16:17:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (60, CAST(N'2017-07-16' AS Date), 12, NULL, 7, N'Streets of Toronto', N'Finished', CAST(7.0 AS Decimal(3, 1)), CAST(0 AS Decimal(1, 0)), 14, NULL)
GO
...
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (102, CAST(N'2017-06-10' AS Date), 7, NULL, 9, N'Tempelhof Airport Street Circuit', N'Finished', CAST(6.0 AS Decimal(3, 1)), CAST(0 AS Decimal(1, 0)), 32, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (103, CAST(N'2017-06-11' AS Date), 8, NULL, 9, N'Tempelhof Airport Street Circuit', N'Finished', CAST(7.0 AS Decimal(3, 1)), CAST(0 AS Decimal(1, 0)), 30, NULL)
GO
...
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (867, CAST(N'2019-05-25' AS Date), 10, NULL, 45, N'Tempelhof Airport Street Circuit', N'Finished', CAST(6.0 AS Decimal(3, 1)), CAST(0 AS Decimal(1, 0)), 31, NULL)
GO
...
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (941, CAST(N'2019-07-14' AS Date), 11, NULL, 48, N'Streets of Toronto', N'Finished', CAST(4.0 AS Decimal(3, 1)), CAST(0 AS Decimal(1, 0)), 14, NULL)
GO
...
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (973, CAST(N'2020-02-23' AS Date), 5, N'6 Hours of Sao Paolo', 50, N'Autódromo José Carlos Pace, Interlagos', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (974, CAST(N'2020-03-20' AS Date), 6, N'1000 Miles of Sebring', 50, N'Sebring International Raceway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (975, CAST(N'2020-04-25' AS Date), 7, N'6 Hours of Spa-Francorchamps', 50, N'Circuit de Spa-Francorchamps', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (976, CAST(N'2020-06-13' AS Date), 8, N'24 Heures du Mans', 50, N'Circuit de la Sarthe, Le Mans', N'Scheduled', NULL, NULL, NULL, NULL)
GO
...
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (980, CAST(N'2020-02-15' AS Date), 4, NULL, 51, N'Autódromo Hermanos Rodríguez, Mexico City', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (981, CAST(N'2020-02-29' AS Date), 5, NULL, 51, N'Circuit International Automobile Moulay El Hassan', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (982, CAST(N'2020-03-21' AS Date), 6, NULL, 51, N'Haitang Bay Circuit, Sanya', N'Cancelled', CAST(0.0 AS Decimal(3, 1)), NULL, NULL, N'Cancelled due to Corona virus outbreak.')
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (983, CAST(N'2020-04-04' AS Date), 7, NULL, 51, N'Circuito Cittadino dell''EUR, Rome', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (984, CAST(N'2020-04-18' AS Date), 8, NULL, 51, N'Circuit des Invalides, Paris', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (985, CAST(N'2020-05-03' AS Date), 9, NULL, 51, N'Seoul Street Circuit', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (986, CAST(N'2020-06-06' AS Date), 10, NULL, 51, N'Jakarta Street Circuit', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (987, CAST(N'2020-06-21' AS Date), 11, NULL, 51, N'Tempelhof Airport Street Circuit', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (988, CAST(N'2020-07-11' AS Date), 12, NULL, 51, N'Brooklyn Street Circuit, New York', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (989, CAST(N'2020-07-25' AS Date), 13, NULL, 51, N'ExCel London', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (990, CAST(N'2020-07-26' AS Date), 14, NULL, 51, N'ExCel London', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (991, CAST(N'2020-02-09' AS Date), 0, N'Busch Clash', 52, N'Daytona International Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (992, CAST(N'2020-02-13' AS Date), 0, N'Bluegreen Vacations Duel 1', 52, N'Daytona International Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (993, CAST(N'2020-02-13' AS Date), 0, N'Bluegreen Vacations Duel 2', 52, N'Daytona International Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (994, CAST(N'2020-02-16' AS Date), 1, N'Daytona 500', 52, N'Daytona International Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (995, CAST(N'2020-02-23' AS Date), 2, NULL, 52, N'Las Vegas Motor Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (996, CAST(N'2020-03-01' AS Date), 3, NULL, 52, N'Auto Club Speedway, Fontana', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (997, CAST(N'2020-03-08' AS Date), 4, NULL, 52, N'ISM Raceway, Phoenix', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (998, CAST(N'2020-03-15' AS Date), 5, NULL, 52, N'Atlanta Motor Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (999, CAST(N'2020-03-22' AS Date), 6, NULL, 52, N'Homestead-Miami Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1000, CAST(N'2020-03-29' AS Date), 7, NULL, 52, N'Texas Motor Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1001, CAST(N'2020-04-05' AS Date), 8, NULL, 52, N'Bristol Motor Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1002, CAST(N'2020-04-19' AS Date), 9, NULL, 52, N'Richmond Raceway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1003, CAST(N'2020-04-26' AS Date), 10, NULL, 52, N'Talladega Superspeedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1004, CAST(N'2020-05-03' AS Date), 11, NULL, 52, N'Dover International Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1005, CAST(N'2020-05-09' AS Date), 12, NULL, 52, N'Martinsville Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1006, CAST(N'2020-05-16' AS Date), 0, N'All-Star Open', 52, N'Charlotte Motor Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1007, CAST(N'2020-05-16' AS Date), 0, N'All-Star Race', 52, N'Charlotte Motor Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1008, CAST(N'2020-05-24' AS Date), 13, N'Coca-Cola 600', 52, N'Charlotte Motor Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1009, CAST(N'2020-05-31' AS Date), 14, NULL, 52, N'Kansas Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1010, CAST(N'2020-06-07' AS Date), 15, NULL, 52, N'Michigan International Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1011, CAST(N'2020-06-14' AS Date), 16, NULL, 52, N'Sonoma Raceway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1012, CAST(N'2020-06-21' AS Date), 17, NULL, 52, N'Chicagoland Speedway, Chicago', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1013, CAST(N'2020-06-27' AS Date), 18, NULL, 52, N'Pocono Raceway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1014, CAST(N'2020-06-28' AS Date), 19, NULL, 52, N'Pocono Raceway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1015, CAST(N'2020-07-05' AS Date), 20, N'Brickyard 400', 52, N'Indianapolis Motor Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1016, CAST(N'2020-07-11' AS Date), 21, NULL, 52, N'Kentucky Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1017, CAST(N'2020-07-19' AS Date), 22, NULL, 52, N'New Hampshire Motor Speedway, Loudon', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1018, CAST(N'2020-08-09' AS Date), 23, NULL, 52, N'Michigan International Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1019, CAST(N'2020-08-16' AS Date), 24, NULL, 52, N'Watkins Glen International', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1020, CAST(N'2020-08-23' AS Date), 25, NULL, 52, N'Dover International Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1021, CAST(N'2020-08-29' AS Date), 26, NULL, 52, N'Daytona International Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1022, CAST(N'2020-09-06' AS Date), 27, N'Southern 500', 52, N'Darlington Raceway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1023, CAST(N'2020-09-12' AS Date), 28, NULL, 52, N'Richmond Raceway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1024, CAST(N'2020-09-19' AS Date), 29, NULL, 52, N'Bristol Motor Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1025, CAST(N'2020-09-27' AS Date), 30, NULL, 52, N'Las Vegas Motor Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1026, CAST(N'2020-10-04' AS Date), 31, NULL, 52, N'Talladega Superspeedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1027, CAST(N'2020-10-11' AS Date), 32, NULL, 52, N'Charlotte Motor Speedway Road Course', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1028, CAST(N'2020-10-18' AS Date), 33, NULL, 52, N'Kansas Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1029, CAST(N'2020-10-25' AS Date), 34, NULL, 52, N'Texas Motor Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1030, CAST(N'2020-11-01' AS Date), 35, NULL, 52, N'Martinsville Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1031, CAST(N'2020-11-08' AS Date), 36, NULL, 52, N'ISM Raceway, Phoenix', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1032, CAST(N'2020-03-08' AS Date), 1, NULL, 53, N'Losail Circuit', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1033, CAST(N'2020-03-22' AS Date), 2, NULL, 53, N'Chang International Circuit, Buriram', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1034, CAST(N'2020-04-05' AS Date), 3, NULL, 53, N'Circuit of the Americas, Austin, Texas', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1035, CAST(N'2020-04-19' AS Date), 4, NULL, 53, N'Termas de Río Hondo', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1036, CAST(N'2020-05-03' AS Date), 5, NULL, 53, N'Circuito de Jerez-Ángel Nieto Jerez de la Frontera', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1037, CAST(N'2020-05-17' AS Date), 6, NULL, 53, N'Circuit Bugatti, Le Mans', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1038, CAST(N'2020-05-31' AS Date), 7, NULL, 53, N'Mugello Circuit, Scarperia', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1039, CAST(N'2020-06-07' AS Date), 8, NULL, 53, N'Circuit de Barcelona-Catalunya', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1040, CAST(N'2020-06-21' AS Date), 9, NULL, 53, N'Sachsenring, Hohenstein-Ernstthal', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1041, CAST(N'2020-06-28' AS Date), 10, NULL, 53, N'TT Circuit Assen', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1042, CAST(N'2020-07-12' AS Date), 11, NULL, 53, N'Kymi Ring, Iitti', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1043, CAST(N'2020-08-09' AS Date), 12, NULL, 53, N'Masaryk Circuit, Brno', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1044, CAST(N'2020-08-16' AS Date), 13, NULL, 53, N'Red Bull Ring, Spielberg', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1045, CAST(N'2020-08-30' AS Date), 14, NULL, 53, N'Silverstone Circuit', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1046, CAST(N'2020-09-13' AS Date), 15, NULL, 53, N'Misano World Circuit Marco Simoncelli', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1047, CAST(N'2020-10-04' AS Date), 16, NULL, 53, N'Ciudad del Motor de Aragón', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1048, CAST(N'2020-10-18' AS Date), 17, NULL, 53, N'Twin Ring Motegi', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1049, CAST(N'2020-10-25' AS Date), 18, NULL, 53, N'Phillip Island Circuit', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1050, CAST(N'2020-11-01' AS Date), 19, NULL, 53, N'Sepang International Circuit, Kuala Lumpur', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1051, CAST(N'2020-11-15' AS Date), 20, NULL, 53, N'Circuit Ricardo Tormo, Valencia', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1052, CAST(N'2020-03-15' AS Date), 1, NULL, 54, N'Albert Park, Melbourne', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1053, CAST(N'2020-03-22' AS Date), 2, NULL, 54, N'Bahrain International Circuit, Sakhir', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1054, CAST(N'2020-04-05' AS Date), 3, NULL, 54, N'Hanoi Street Circuit, Hanoi', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1055, CAST(N'2020-04-19' AS Date), 4, NULL, 54, N'Shanghai International Circuit', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1056, CAST(N'2020-05-03' AS Date), 5, NULL, 54, N'Circuit Zandvoort', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1057, CAST(N'2020-05-10' AS Date), 6, NULL, 54, N'Circuit de Barcelona-Catalunya', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1058, CAST(N'2020-05-24' AS Date), 7, NULL, 54, N'Circuit de Monaco, Monte Carlo', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1059, CAST(N'2020-06-07' AS Date), 8, NULL, 54, N'Baku City Circuit', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1060, CAST(N'2020-06-14' AS Date), 9, NULL, 54, N'Circuit Gilles Villeneuve, Montréal', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1061, CAST(N'2020-06-28' AS Date), 10, NULL, 54, N'Circuit Paul Ricard, Le Castellet', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1062, CAST(N'2020-07-05' AS Date), 11, NULL, 54, N'Red Bull Ring, Spielberg', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1063, CAST(N'2020-07-19' AS Date), 12, NULL, 54, N'Silverstone Circuit', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1064, CAST(N'2020-08-02' AS Date), 13, NULL, 54, N'Hungaroring, Budapest', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1065, CAST(N'2020-08-30' AS Date), 14, NULL, 54, N'Circuit de Spa-Francorchamps', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1066, CAST(N'2020-09-06' AS Date), 15, NULL, 54, N'Autodromo Nazionale Monza', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1067, CAST(N'2020-09-20' AS Date), 16, NULL, 54, N'Marina Bay Street Circuit, Singapore', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1068, CAST(N'2020-09-27' AS Date), 17, NULL, 54, N'Sochi Autodrom', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1069, CAST(N'2020-10-11' AS Date), 18, NULL, 54, N'Suzuka Circuit', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1070, CAST(N'2020-10-25' AS Date), 19, NULL, 54, N'Circuit of the Americas, Austin, Texas', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1071, CAST(N'2020-11-01' AS Date), 20, NULL, 54, N'Autódromo Hermanos Rodríguez, Mexico City', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1072, CAST(N'2020-11-15' AS Date), 21, NULL, 54, N'Autódromo José Carlos Pace, Interlagos', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1073, CAST(N'2020-11-29' AS Date), 22, NULL, 54, N'Yas Marina Circuit, Abu Dhabi', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1074, CAST(N'2020-03-15' AS Date), 1, NULL, 55, N'Streets of St. Petersburg', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1075, CAST(N'2020-04-05' AS Date), 2, NULL, 55, N'Barber Motorsports Park, Alabama', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1076, CAST(N'2020-04-19' AS Date), 3, NULL, 55, N'Streets of Long Beach', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1077, CAST(N'2020-04-26' AS Date), 4, NULL, 55, N'Circuit of the Americas, Austin, Texas', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1078, CAST(N'2020-05-09' AS Date), 5, NULL, 55, N'Indianapolis Motor Speedway Road Course', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1079, CAST(N'2020-05-24' AS Date), 6, N'Indianapolis 500', 55, N'Indianapolis Motor Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1080, CAST(N'2020-05-30' AS Date), 7, NULL, 55, N'Belle Isle, Detroit', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1081, CAST(N'2020-05-31' AS Date), 8, NULL, 55, N'Belle Isle, Detroit', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1082, CAST(N'2020-06-06' AS Date), 9, NULL, 55, N'Texas Motor Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1083, CAST(N'2020-06-21' AS Date), 10, NULL, 55, N'Road America, Elkhart Lake', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1084, CAST(N'2020-06-27' AS Date), 11, NULL, 55, N'Richmond Raceway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1085, CAST(N'2020-07-12' AS Date), 12, NULL, 55, N'Streets of Toronto', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1086, CAST(N'2020-07-18' AS Date), 13, NULL, 55, N'Iowa Speedway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1087, CAST(N'2020-08-16' AS Date), 14, NULL, 55, N'Mid-Ohio Sports Car Course, Lexington', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1088, CAST(N'2020-08-22' AS Date), 15, NULL, 55, N'Gateway Motorsports Park, St. Louis', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1089, CAST(N'2020-09-06' AS Date), 16, NULL, 55, N'Portland International Raceway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1090, CAST(N'2020-09-20' AS Date), 17, NULL, 55, N'Laguna Seca Raceway', N'Scheduled', NULL, NULL, NULL, NULL)
GO
...
GO
INSERT [dbo].[Season] ([Id], [Sport], [Label], [WinningTeam]) VALUES (50, N'WEC', NULL, NULL)
GO
INSERT [dbo].[Season] ([Id], [Sport], [Label], [WinningTeam]) VALUES (51, N'FE', NULL, NULL)
GO
INSERT [dbo].[Season] ([Id], [Sport], [Label], [WinningTeam]) VALUES (52, N'NASCAR', N'Cup Series 2020', NULL)
GO
INSERT [dbo].[Season] ([Id], [Sport], [Label], [WinningTeam]) VALUES (53, N'MotoGP', NULL, NULL)
GO
INSERT [dbo].[Season] ([Id], [Sport], [Label], [WinningTeam]) VALUES (54, N'F1', NULL, NULL)
GO
INSERT [dbo].[Season] ([Id], [Sport], [Label], [WinningTeam]) VALUES (55, N'Indycar', NULL, NULL)
GO
...
GO
INSERT [dbo].[Team] ([Id], [Name], [Sport], [Country]) VALUES (23, N'Tech 3', N'MotoGP', N'FR')
GO
...
GO
INSERT [dbo].[Venue] ([Name], [Country]) VALUES (N'Jakarta Street Circuit', N'ID')
GO
