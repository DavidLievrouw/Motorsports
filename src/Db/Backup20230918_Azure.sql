USE [master]
GO
/****** Object:  Database [Motorsports]    Script Date: 18/09/2023 9:59:59 ******/
...
USE [Motorsports]
GO
/****** Object:  User [MotorsportsApp]    Script Date: 18/09/2023 9:59:59 ******/
...
GO
/****** Object:  Table [dbo].[Country]    Script Date: 18/09/2023 9:59:59 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Participant]    Script Date: 18/09/2023 9:59:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Round]    Script Date: 18/09/2023 9:59:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RoundWinner]    Script Date: 18/09/2023 9:59:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Season]    Script Date: 18/09/2023 9:59:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SeasonEntry]    Script Date: 18/09/2023 9:59:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SeasonWinner]    Script Date: 18/09/2023 9:59:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Sport]    Script Date: 18/09/2023 9:59:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Status]    Script Date: 18/09/2023 9:59:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Team]    Script Date: 18/09/2023 9:59:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[User]    Script Date: 18/09/2023 9:59:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Venue]    Script Date: 18/09/2023 9:59:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1464, CAST(N'2023-05-28' AS Date), 6, N'Indianapolis 500', 72, N'Indianapolis Motor Speedway', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1465, CAST(N'2023-06-04' AS Date), 7, NULL, 72, N'Detroit Downtown Circuit', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1466, CAST(N'2023-06-18' AS Date), 8, NULL, 72, N'Road America, Elkhart Lake', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1467, CAST(N'2023-07-02' AS Date), 9, NULL, 72, N'Mid-Ohio Sports Car Course, Lexington', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1468, CAST(N'2023-07-16' AS Date), 10, NULL, 72, N'Exhibition Place, Toronto', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1469, CAST(N'2023-07-22' AS Date), 11, NULL, 72, N'Iowa Speedway', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1470, CAST(N'2023-07-23' AS Date), 12, NULL, 72, N'Iowa Speedway', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1471, CAST(N'2023-08-06' AS Date), 13, NULL, 72, N'Nashville Street Circuit', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1472, CAST(N'2023-08-12' AS Date), 14, NULL, 72, N'Indianapolis Motor Speedway Road Course', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1473, CAST(N'2023-08-27' AS Date), 15, NULL, 72, N'Gateway Motorsports Park, St. Louis', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
...
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1494, CAST(N'2023-05-28' AS Date), 14, N'Coca-Cola 600', 73, N'Charlotte Motor Speedway', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1495, CAST(N'2023-06-04' AS Date), 15, NULL, 73, N'Gateway Motorsports Park, St. Louis', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1496, CAST(N'2023-06-11' AS Date), 16, NULL, 73, N'Sonoma Raceway', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1497, CAST(N'2023-06-25' AS Date), 17, NULL, 73, N'Nashville Superspeedway', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1498, CAST(N'2023-07-02' AS Date), 18, NULL, 73, N'Chicago Street Course', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1499, CAST(N'2023-07-09' AS Date), 19, NULL, 73, N'Atlanta Motor Speedway', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1500, CAST(N'2023-07-16' AS Date), 20, NULL, 73, N'New Hampshire Motor Speedway, Loudon', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1501, CAST(N'2023-07-23' AS Date), 21, NULL, 73, N'Pocono Raceway', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1502, CAST(N'2023-07-30' AS Date), 22, NULL, 73, N'Richmond Raceway', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1503, CAST(N'2023-08-06' AS Date), 23, NULL, 73, N'Michigan International Speedway', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1504, CAST(N'2023-08-13' AS Date), 24, NULL, 73, N'Indianapolis Motor Speedway Road Course', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1505, CAST(N'2023-08-20' AS Date), 25, NULL, 73, N'Watkins Glen International', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[Round] ([Id], [Date], [Number], [Name], [Season], [Venue], [Status], [Rating], [Rain], [WinningTeam], [Note]) VALUES (1506, CAST(N'2023-08-26' AS Date), 26, NULL, 73, N'Daytona International Speedway', N'ReadyToWatch', NULL, NULL, NULL, NULL)
GO
